    ...
    return (
        <main className="flex flex-col items-center">
            ...
            <section className="w-full min-h-[75vh] flex flex-col items-center justify-center text-center px-4 pt-20 relative overflow-hidden">
                ...
                >
                    Authentisches Asia Food. <br className="hidden md:block" />
                    <span className="text-viet-green">Kompromisslos</span> lecker.
                </motion.h1>
                ...
                >
                    Vergiss den Standard-Imbiss. Wir bringen echte vietnamesische Streetfood-Kultur nach Sömmerda. <span className="text-white font-semibold">Knusprig, frisch und mit Leidenschaft im Wok zubereitet.</span>
                </motion.p>
